...
public class VoiceMessageService {
    public String voiceToMessage(byte[] bytes, String language) {
        try (SpeechClient speechClient = SpeechClient.create()) {
            ...
            return "дело было так когда беглец сбежал то он добежал до реки от одного берега до другова берега" +
                    " лежала доска вся гнилая и тонкая на другом берегу он увидел друга обрадовавшийся беглец хотел бежать по этой доске " +
                    "но друг выхватил доску из-под ног беглеца и тот утонул " +
                    "а враг засмеявшись, ушел прочь";
        }
    }
}
